                    ...
                    if (J == MatrixCount - 1)
                    {
                        ...
                        for (u32 K = 1; K < MatrixCount; K++)
                        {
                            ...
                            if (strcmp(Algorithm, "simple") == 0)
                            {
                                ...
                                f32 K = CurrentWidth;
                                f32 N = ResultWidth;
                                f32 FlopsPerByte = (2 * M * N * K) / (4 * (M * K + K * N + M * N));

                                TimeCudaBandwidth("Simple Matmul", SizeA + SizeB, SizeC, FlopsPerByte);
                            ...
                            else
                            {
                                ...
                                TimeCudaBandwidth("Tiled Matmul", SizeA + SizeB, SizeC, FlopsPerByte);
